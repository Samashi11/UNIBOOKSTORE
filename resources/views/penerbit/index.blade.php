...
@section('navbar')
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Publishers</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Publishers</h6>
        </nav>
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-dark text-xs font-weight-bolder opacity-7 ps-2" >Alamat</th>
                        <th class="text-uppercase text-dark text-xs font-weight-bolder opacity-7 ps-2" >Kota</th>
                        <th class="text-uppercase text-dark text-xs font-weight-bolder opacity-7 ps-2" >Telepon</th>
                    </tr>
                </thead>
                    <tbody>
                        @foreach ($penerbits as $penerbit)
                            <tr>
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <p class="mb-0 text-xs font-weight-bold">{{ $penerbit->kode }}</p>
                                        {{-- <p class="text-xs text-secondary mb-0">michael@creative-tim.com</p> --}}
                                    </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $penerbit->nama }}</p>
                                ...
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $penerbit->kota }}</p>
                                </td>
                                <td>
                                    @php
                                        $telepon = $penerbit->telepon;
                                        $formattedTelepon = strlen($telepon) > 10 ?
                                            substr($telepon, 0, 4) . '-' . substr($telepon, 4, 4) . '-' . substr($telepon, 8) :
                                            $telepon;
                                    @endphp
                                    <p class="text-xs font-weight-bold mb-0">{{ $formattedTelepon }}</p>
                                </td>
                                <td class="align-middle">
                                    <a class="btn btn-link text-dark px-1 mb-0" href="{{ route('penerbit.edit',$penerbit->id) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                    ...
                    <tfoot>
                        <tr class="">
                            ...
                            <td></td>
                            <td></td>
                            <td class="float-end">{{ $penerbits->withQueryString()->links() }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
