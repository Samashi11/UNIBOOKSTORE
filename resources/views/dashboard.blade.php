    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pt-2 pe-md-3 d-flex align-items-center">
                <form class="d-flex" role="search" action="{{ route('admin') }}" method="GET">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="d-flex flex-column h-100">
                                <p class="mb-1 pt-2 text-bold">UNIBOOKSTORE</p>
                                <h5 class="font-weight-bolder">Platform Penjualan Buku Online</h5>
                                <p class="mb-5">Dari pilihan buku terbaik hingga kemudahan pembelian, temukan semua yang Anda butuhkan di Unibookstore untuk memenuhi kebutuhan literasi Anda.</p>
                        ...
                        @foreach ($book as $buku)
                            <tr>
                                <td>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <p class="mb-0 text-xs font-weight-bold">{{ $buku->kode }}</p>
                                        {{-- <p class="text-xs text-secondary mb-0">michael@creative-tim.com</p> --}}
                                    </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $buku->kategori }}</p>
                                    {{-- <p class="text-xs text-secondary mb-0">Developer</p> --}}
                                </td>
                                <td class="align-middle">
                                    <span class="text-xs font-weight-bold">{{ $buku->nama_buku }}</span>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ number_format($buku->harga, 0, ',', '.') }}</p>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $buku->stok }}</p>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $buku->penerbit->nama }}</p>
                                </td>
                                {{-- <td class="align-middle">
